...
DEFAULT_OPENWAKEWORD_REPO = Path("/home/clive/PycharmProjects/openWakeWord")
DEFAULT_ORAC_REPO = Path("/home/clive/PycharmProjects/Orac")
DEFAULT_WORKSPACE_ROOT = Path("~/OracWakeLab/projects").expanduser()
