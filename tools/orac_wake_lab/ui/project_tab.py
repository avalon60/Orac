...
from tools.orac_wake_lab.models.project import DEFAULT_OPENWAKEWORD_REPO
from tools.orac_wake_lab.models.project import DEFAULT_ORAC_REPO
from tools.orac_wake_lab.models.project import DEFAULT_WORKSPACE_ROOT
from tools.orac_wake_lab.models.project import WakeWordProject
from tools.orac_wake_lab.models.validation import derive_model_name
from tools.orac_wake_lab.models.validation import validate_model_name
from tools.orac_wake_lab.models.validation import validate_phrase
from tools.orac_wake_lab.services.project_store import create_project_workspace
from tools.orac_wake_lab.services.project_store import project_dir_for_model
from tools.orac_wake_lab.services.training_config import write_training_config
...
class ProjectTab(ctk.CTkFrame):
    ...
    def __init__(self, master: ctk.CTkBaseClass, app: object) -> None:
        ...
        self.piper_path_var = ctk.StringVar(value="")
        self.background_paths_var = ctk.StringVar(value="")
        self.rir_paths_var = ctk.StringVar(value="")
    ...
    def _build(self) -> None:
        ...
        rows = [
            ...
            ("Piper generator path", self.piper_path_var),
            ("Background dirs", self.background_paths_var),
            ("RIR dirs", self.rir_paths_var),
            ("Negative feature .npy files", self.negative_feature_paths_var),
            ("False-positive .npy", self.validation_path_var),
        ...
        ).grid(row=9, column=1, padx=12, pady=6, sticky="w")
        ctk.CTkButton(
            self,
            text="Create / Save Project",
            command=self.create_project,
        ).grid(row=10, column=1, padx=12, pady=12, sticky="w")
