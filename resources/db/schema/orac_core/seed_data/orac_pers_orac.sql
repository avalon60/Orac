...
--changeset clive:seed_data_orac_core_seed_data_orac_pers_orac context:core labels:core stripComments:false runOnChange:true
...
--rollback delete from orac_core.orac_personalities where personality_code in ('ORAC');
