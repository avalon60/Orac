...
--   Date and Time:   18:25 Saturday April 25, 2026
--   Exported By:     ADMIN
--   Export Type:     Workspace Export
--   Version:         24.2.0
--   Instance ID:     1046114516067618
--
-- Import:
...
wwv_flow_fnd_user_api.create_company (
 ...
 ,p_short_name => 'ORAC'
 ,p_display_name => 'ORAC'
 ,p_first_schema_provisioned => 'ORAC_APX_PUB'
 ,p_company_schemas => 'ORAC_API:ORAC_APX_PUB:ORAC_CODE'
...
wwv_flow_fnd_user_api.create_fnd_user (
  ...
  p_default_schema               => 'ORAC_APX_PUB',
  p_account_locked               => 'N',
  p_account_expiry               => to_date('202604251816','YYYYMMDDHH24MI'),
