...
--changeset clive:create_package_spec_orac_code_package_spec_orac_personalities_api context:core labels:core stripComments:false splitStatements:false endDelimiter:/ runOnChange:true
-- __author__: clive
-- __date__: 2026-04-29
...
create or replace package orac_code.orac_personalities_api as
  procedure ins(
    ...
    p_model_preset_id     in     orac_api.orac_personalities_v.model_preset_id%type default null,
...
--rollback drop package orac_code.orac_personalities_api;
